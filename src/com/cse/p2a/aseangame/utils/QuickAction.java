...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public void addActionItem(ActionItem action) {
        ...
        TextView scoreTxt = (TextView) container.findViewById(R.id.tv_score);
        ...
        if (pos == 0) { // Detect first item of action list
            container.setBackgroundResource(R.color.popover_title_color);
        }
